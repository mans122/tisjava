...
//	private static JLabel[] sText = new JLabel[100];
//	private static JLabel[] rText = new JLabel[100];
//	private static ArrayList<JLabel> reText = new ArrayList<>();
//	public ChatServer() {
//		setTitle("서버 채팅 창");
...
//		cPanel.add(rText[receiveCount]);
//		rText[receiveCount].setText("클라로부터 연결완료");
//		rText[receiveCount].requestFocus();
//		receiveCount++;
...
//				out.flush();
//				
//				cPanel.add(sText[sendCount]);				
//				sText[sendCount].setText("\n"+mynick+": "+msg);
//				sendCount++;
//				csPanel.getVerticalScrollBar().setValue(csPanel.getVerticalScrollBar().getMaximum());
//				sender.setText(null);
//				}
